            ...
            <div className="container grid grid-cols-[300px_1fr] gap-32">
                ...
                <div className="flex flex-row gap-6">
                    <div className={`${isDarkMode ? 'bg-white bg-opacity-5' : 'bg-white'} relative flex flex-col gap-6 p-6 rounded-lg`}>
                        ...
                        <p className={`text-lg ${isDarkMode ? 'text-dimmedText' : ''}`}> Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt modi aperiam aut natus, debitis maiores dicta, delectus eius veniam itaque perspiciatis beatae. Veritatis, porro asperiores?</p>
                    ...
                    <div className={`${isDarkMode ? 'bg-white bg-opacity-5' : 'bg-white'} relative flex flex-col gap-6 p-6 rounded-lg`}>
                        ...
                        <p className={`${isDarkMode ? 'text-dimmedText' : ''} text-lg`}> Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt modi aperiam aut natus, debitis maiores dicta, delectus eius veniam itaque perspiciatis beatae. Veritatis, porro asperiores?</p>
                        <div className="flex gap-3">
